...
const HeroContact = props => {
  return (
    <section className="">
      <h1 className="heading--hero--secondary text-center mb-4 md:mb-6">
        Contact
      </h1>
      <h2 className="text-coral text-[2rem] leading-[3rem] text-center font-bold mb-10 md:mb-6">
        Ask us about
      </h2>
      <div className="grid gap-y-6 md:gap-y-2 md:max-w-[475px] md:mx-auto">
